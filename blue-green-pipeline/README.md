...
![Blue/Green](https://github.com/maximilianoPizarro/cloud-native-deployment-strategies/raw/main/images/blue-green.png)
...
![Blue/Green Switch](https://github.com/maximilianoPizarro/cloud-native-deployment-strategies/raw/main/images/blue-green-switch.png)
...
![Shop Blue/Green](https://github.com/maximilianoPizarro/cloud-native-deployment-strategies/raw/main/images/Shop-blue-green.png)
...
![Shop Umbrella Helm Chart](https://github.com/maximilianoPizarro/cloud-native-deployment-strategies/raw/main/images/Shop-helm.png)
...
![Argo CD - Cluster Config](https://github.com/maximilianoPizarro/cloud-native-deployment-strategies/raw/main/images/application-cluster-config-sync.png)
...
![Shop initial status](https://github.com/maximilianoPizarro/cloud-native-deployment-strategies/raw/main/images/blue-green-step-0.png)
...
```
![Pipeline step 1](https://github.com/maximilianoPizarro/cloud-native-deployment-strategies/raw/main/images/pipeline-step-1.png)
...
![Shop step 1](https://github.com/maximilianoPizarro/cloud-native-deployment-strategies/raw/main/images/blue-green-step-1.png)
...
![Pipeline step 2](https://github.com/maximilianoPizarro/cloud-native-deployment-strategies/raw/main/images/pipeline-step-3.png)
After the pipeline is finished and ArgoCD has synchronized the changes this will be the `Shop` status:
![Shop step 2](https://github.com/maximilianoPizarro/cloud-native-deployment-strategies/raw/main/images/blue-green-step-2.png)
...
![Pipeline step 2,5 Rollback](https://github.com/maximilianoPizarro/cloud-native-deployment-strategies/raw/main/images/pipeline-step-3-rollback.png)
After the pipeline is finished and ArgoCD has synchronized the changes this will be the `Shop` status:
![Shop step 2,5 Rollback](https://github.com/maximilianoPizarro/cloud-native-deployment-strategies/raw/main/images/blue-green-step-2-5.png)
...
![Pipeline step 3](https://github.com/maximilianoPizarro/cloud-native-deployment-strategies/raw/main/images/pipeline-step-4.png)
After the pipeline is finished and ArgoCD has synchronized the changes this will be the `Shop` status:
![Shop step 3](https://github.com/maximilianoPizarro/cloud-native-deployment-strategies/raw/main/images/blue-green-step-3.png)
